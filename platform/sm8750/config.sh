...
# Platform configuration file for Samsung Snapdragon 8 Elite devices (sm8750)
TARGET_BOARD_API_LEVEL=35
TARGET_PRODUCT_SHIPPING_API_LEVEL=35

# Partitions
TARGET_BOOT_PARTITION_SIZE=101122048
TARGET_DTBO_PARTITION_SIZE=20971520
TARGET_INIT_BOOT_PARTITION_SIZE=8388608
TARGET_VENDOR_BOOT_PARTITION_SIZE=134217728

# Dynamic partitions
TARGET_USE_DYNAMIC_PARTITIONS=true
TARGET_SUPER_PARTITION_SIZE=19398656000
TARGET_SUPER_GROUP_NAME="qti_dynamic_partitions"
TARGET_QTI_DYNAMIC_PARTITIONS_SIZE=19394461696
...
TARGET_LCD_CONFIG_HFR_SUPPORTED_REFRESH_RATE="24,10,30,48,60,80,120"
TARGET_LCD_SUPPORT_MDNIE_HW=true
TARGET_RIL_FEATURES="onebinary entitlement_sa"
...
TARGET_WLAN_CONFIG_DYNAMIC_SWITCH="5"
