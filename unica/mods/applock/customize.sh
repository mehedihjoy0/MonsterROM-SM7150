...
SMALI_PATCH "system" "system/framework/framework.jar" "smali_classes6/com/samsung/android/rune/CoreRune.smali" "replaceall" \
    "sput-boolean v2, Lcom/samsung/android/rune/CoreRune;->FW_SUPPORT_APPLOCK:Z" \
    "const/4 v2, 0x1\n\n    sput-boolean v2, Lcom/samsung/android/rune/CoreRune;->FW_SUPPORT_APPLOCK:Z"
SMALI_PATCH "system" "system/priv-app/SecSettings/SecSettings.apk"\
    "smali_classes2/com/samsung/android/settings/usefulfeature/applock/AppLockPreferenceController.smali"\
