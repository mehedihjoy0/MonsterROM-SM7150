.class public final Lio/mesalabs/monsterromreborn/settings/keybox/KeyboxUtils;
...
.method static synthetic lambda$setKeyboxPrefSummary$0(ILandroidx/preference/Preference;Landroid/content/Context;)V
    ...
    const-string v0, "monsterrom_reborn_keybox_status_loaded"

    const-string v1, "string"

    invoke-static {v1, v0}, Lio/mesalabs/monsterromreborn/utils/Utils;->getResourceId(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v3, v2}, Lio/mesalabs/monsterromreborn/utils/Utils;->getResourceId(Ljava/lang/String;Ljava/lang/String;)I

    move-result v2

    if-nez p0, :cond_0

    const-string p0, "monsterrom_reborn_keybox_status_valid"

    invoke-static {v1, p0}, Lio/mesalabs/monsterromreborn/utils/Utils;->getResourceId(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string p0, "monsterrom_reborn_keybox_status_revoked"
    ...
    invoke-static {v3, p0}, Lio/mesalabs/monsterromreborn/utils/Utils;->getResourceId(Ljava/lang/String;Ljava/lang/String;)I
...
.method static synthetic lambda$setKeyboxPrefSummary$1(Landroid/content/Context;Landroid/os/Handler;Landroidx/preference/Preference;)V
    ...
    invoke-static {p0}, Lio/mesalabs/monsterromreborn/settings/keybox/KeyboxUtils;->verifyKeybox(Landroid/content/Context;)I

    move-result v0

    new-instance v1, Lio/mesalabs/monsterromreborn/settings/keybox/KeyboxUtils$$ExternalSyntheticLambda1;

    invoke-direct {v1, v0, p2, p0}, Lio/mesalabs/monsterromreborn/settings/keybox/KeyboxUtils$$ExternalSyntheticLambda1;-><init>(ILandroidx/preference/Preference;Landroid/content/Context;)V
...
.method public static setKeyboxData(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-static {p0, v0}, Lio/mesalabs/monsterromreborn/settings/keybox/KeyboxUtils;->validateXml(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0}, Lio/mesalabs/monsterromreborn/settings/keybox/KeyboxUtils;->showToast(Landroid/content/Context;I)V

    invoke-static {p0}, Lio/mesalabs/monsterromreborn/settings/pif/PIFUtils;->killGMS(Landroid/content/Context;)V
    :try_end_4
    ...
    invoke-static {p0, p1}, Lio/mesalabs/monsterromreborn/settings/keybox/KeyboxUtils;->showToast(Landroid/content/Context;I)V
...
.method public static setKeyboxPrefSummary(Landroid/content/Context;Landroidx/preference/Preference;)V
    ...
    new-instance v1, Lio/mesalabs/monsterromreborn/settings/keybox/KeyboxUtils$$ExternalSyntheticLambda0;

    invoke-direct {v1, p0, v0, p1}, Lio/mesalabs/monsterromreborn/settings/keybox/KeyboxUtils$$ExternalSyntheticLambda0;-><init>(Landroid/content/Context;Landroid/os/Handler;Landroidx/preference/Preference;)V
...
.method private static showToast(Landroid/content/Context;I)V
    ...
    :cond_0
    const-string p1, "monsterrom_reborn_keybox_toast_not_gak"

    goto :goto_0

    :cond_1
    const-string p1, "monsterrom_reborn_keybox_toast_not_valid"

    goto :goto_0

    :cond_2
    const-string p1, "monsterrom_reborn_keybox_toast_error_xml"

    goto :goto_0

    :cond_3
    const-string p1, "monsterrom_reborn_keybox_toast_error"

    goto :goto_0

    :cond_4
    const-string p1, "monsterrom_reborn_keybox_toast_loaded"

    :goto_0
    const-string v0, "string"

    invoke-static {v0, p1}, Lio/mesalabs/monsterromreborn/utils/Utils;->getResourceId(Ljava/lang/String;Ljava/lang/String;)I
...
.method private static validateXml(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {v0}, Lio/mesalabs/monsterromreborn/settings/keybox/KeyboxUtils;->parseCertificate(Ljava/lang/String;)Ljava/security/cert/X509Certificate;
    ...
    invoke-static {v1, v6}, Lio/mesalabs/monsterromreborn/settings/keybox/KeyboxUtils;->showToast(Landroid/content/Context;I)V
    :try_end_5
    ...
    invoke-static {v1, v5}, Lio/mesalabs/monsterromreborn/settings/keybox/KeyboxUtils;->showToast(Landroid/content/Context;I)V
    ...
    invoke-static {v1, v2}, Lio/mesalabs/monsterromreborn/settings/keybox/KeyboxUtils;->showToast(Landroid/content/Context;I)V
...
.method private static verifyKeybox(Landroid/content/Context;)I
    ...
    invoke-static {v4}, Lio/mesalabs/monsterromreborn/settings/keybox/KeyboxUtils;->parseCertificate(Ljava/lang/String;)Ljava/security/cert/X509Certificate;
