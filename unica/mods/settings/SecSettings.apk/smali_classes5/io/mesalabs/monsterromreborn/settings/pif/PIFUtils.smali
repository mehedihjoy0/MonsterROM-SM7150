.class public final Lio/mesalabs/monsterromreborn/settings/pif/PIFUtils;
...
.field private static final URL:Ljava/lang/String; = "https://raw.githubusercontent.com/devcore94/MonsterROM-REBORN/refs/heads/sixteenQPR2/static_resources/pif/pif.json"
...
.method static synthetic lambda$updatePIF$0(Lorg/json/JSONObject;Landroid/content/Context;Landroidx/preference/Preference;)V
    ...
    :try_start_2
    invoke-static {p0}, Lio/mesalabs/monsterromreborn/settings/pif/PIFUtils;->setPIFProps(Lorg/json/JSONObject;)V

    const/4 p0, 0x1

    invoke-static {p1, p0}, Lio/mesalabs/monsterromreborn/settings/pif/PIFUtils;->showToast(Landroid/content/Context;I)V
    ...
    :goto_2
    invoke-static {p1}, Lio/mesalabs/monsterromreborn/settings/pif/PIFUtils;->killGMS(Landroid/content/Context;)V

    invoke-static {}, Lio/mesalabs/monsterromreborn/settings/pif/PIFUtils;->getFormattedPIFVersion()Ljava/lang/CharSequence;
...
.method static synthetic lambda$updatePIF$1(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0}, Lio/mesalabs/monsterromreborn/settings/pif/PIFUtils;->showToast(Landroid/content/Context;I)V
...
.method static synthetic lambda$updatePIF$2(Landroid/os/Handler;Landroid/content/Context;Landroidx/preference/Preference;)V
    ...
    const-string v1, "https://raw.githubusercontent.com/devcore94/MonsterROM-REBORN/refs/heads/sixteenQPR2/static_resources/pif/pif.json"
    ...
    new-instance v1, Lio/mesalabs/monsterromreborn/settings/pif/PIFUtils$$ExternalSyntheticLambda0;

    invoke-direct {v1, v0, p1, p2}, Lio/mesalabs/monsterromreborn/settings/pif/PIFUtils$$ExternalSyntheticLambda0;-><init>(Lorg/json/JSONObject;Landroid/content/Context;Landroidx/preference/Preference;)V
    ...
    new-instance p2, Lio/mesalabs/monsterromreborn/settings/pif/PIFUtils$$ExternalSyntheticLambda1;

    invoke-direct {p2, p1}, Lio/mesalabs/monsterromreborn/settings/pif/PIFUtils$$ExternalSyntheticLambda1;-><init>(Landroid/content/Context;)V
...
.method public static loadCustomPropsFromUri(Landroid/content/Context;Landroidx/preference/Preference;Landroid/net/Uri;)V
    ...
    :goto_0
    invoke-static {v15}, Lio/mesalabs/monsterromreborn/settings/pif/PIFUtils;->setPIFProps(Lorg/json/JSONObject;)V
    :try_end_4
    ...
    :try_start_5
    invoke-static {v1, v0}, Lio/mesalabs/monsterromreborn/settings/pif/PIFUtils;->showToast(Landroid/content/Context;I)V

    invoke-static {v1}, Lio/mesalabs/monsterromreborn/settings/pif/PIFUtils;->killGMS(Landroid/content/Context;)V
...
.method private static showToast(Landroid/content/Context;I)V
    ...
    :cond_0
    const-string p1, "monsterrom_reborn_pif_toast_error_custom"

    goto :goto_0

    :cond_1
    const-string p1, "monsterrom_reborn_pif_toast_error"

    goto :goto_0

    :cond_2
    const-string p1, "monsterrom_reborn_pif_toast_custom"

    goto :goto_0

    :cond_3
    const-string p1, "monsterrom_reborn_pif_toast_up_to_date"

    goto :goto_0

    :cond_4
    const-string p1, "monsterrom_reborn_pif_toast_updated"

    goto :goto_0

    :cond_5
    const-string p1, "monsterrom_reborn_pif_toast_checking"
...
.method public static updatePIF(Landroid/content/Context;Landroidx/preference/Preference;)V
    ...
    new-instance v1, Lio/mesalabs/monsterromreborn/settings/pif/PIFUtils$$ExternalSyntheticLambda2;

    invoke-direct {v1, v0, p0, p1}, Lio/mesalabs/monsterromreborn/settings/pif/PIFUtils$$ExternalSyntheticLambda2;-><init>(Landroid/os/Handler;Landroid/content/Context;Landroidx/preference/Preference;)V
