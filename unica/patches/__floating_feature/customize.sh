...
APPLY_TARGET_FEATURE()
{
    ...
    while IFS= read -r l; do
        ...
        if IS_SPEN_FLOATING_FEATURE "$FEATURE" || grep -q -w "$FEATURE" <<< "$BLACKLIST"; then
            continue
        fi
...
unset -f IS_SPEN_FLOATING_FEATURE APPLY_TARGET_FEATURE APPLY_CUSTOM_FEATURE
