...
SET_METADATA "odm" "etc/media_profiles_V1_0.xml" 0 0 644 "u:object_r:vendor_configs_file:s0"
LOG_STEP_OUT
...
SET_PROP_INTO_FILE "$TARGET_FIRMWARE_DEST/system/system/build.prop" \
 "ro.system.build.fingerprint" "samsung/m51nsxx/qssi:12/SP1A.210812.016/M515FXXS6DXE4:user/release-keys"
